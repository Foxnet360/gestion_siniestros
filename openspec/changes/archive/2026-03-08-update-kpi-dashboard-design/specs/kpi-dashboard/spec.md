...
El sistema SHALL mostrar el control de backlog con visualización donut y breakdown.

#### Scenario: Visualización Backlog Donut

- **WHEN** se consulta el dashboard
- **THEN** el sistema SHALL mostrar un donut chart con:
  - Siniestros Abiertos: 18% (en naranja/rojo)
  - Siniestros Finalizados: 82% (en verde)
- **AND** SHALL mostrar META: <19%

#### Scenario: Breakdown de Backlog

- **WHEN** el usuario ve el control de backlog
- **THEN** el sistema SHALL mostrar breakdown detallado:
  - ABiertos: 18%
  - Siniestros: 39%
  - Finalizados: 82%
