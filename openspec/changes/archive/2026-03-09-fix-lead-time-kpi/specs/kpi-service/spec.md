# Especificación: Flexibilización del cálculo de Lead Time KPI

## Visión General
El servicio `KpiService.ts` calcula el Lead Time de los siniestros basándose en las fechas de inicio (etapa 1 / aviso) y fin (etapa 16 / finalización). Actualmente esta lógica busca la existencia estricta de una "Etapa 16 - Pagado", de lo contrario excluye el registro del cálculo, lo que resulta en un promedio general tendiendo a 0. Esta especificación define cómo flexibilizar la regla de "siniestro completado".
