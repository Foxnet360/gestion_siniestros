# Spec: Cálculo de días hábiles (Colombia)

## Purpose
TBD: Definition of the business rules for calculating business days in Colombia, excluding weekends and national holidays.
