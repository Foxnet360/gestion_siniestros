...
export interface Claim {
  ...
  // Prescription Management Fields (new)
  /** @ownership Internal - Alert level for prescription/stagnation */
  alert_level?:
    | 'normal'
    | 'warning'
    | 'critical'
    ...
    | 'resolved';
  /** @ownership Internal - Ordinary prescription date (2 years) */
  fecha_prescripcion_ordinaria?: string;
  /** @ownership Internal - Extraordinary prescription date (5 years for RC) */
  fecha_prescripcion_extraordinaria?: string;
